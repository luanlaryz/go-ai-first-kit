...
- Os pilares AI-first, Governança e Documentação reconhecem a camada de backlog governado, os ADRs em `docs/decisions/` e o changelog no formato Keep a Changelog.
...
8. `docs/backlog/Backlog.md` com `skills/26-backlog-item-intake/` para intake governado de backlog.
9. `docs/decisions/` (ADRs) e `docs/release-versioning-policy.md`, `docs/release-notes-policy.md` e `docs/release-checklist.md` para governança de release, versionamento e changelog.
